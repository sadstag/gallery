...
import type { AppliedFilterOnCategory } from '@model/wall/AppliedFilter'
...
export const CategoryFilterPanel = () => {
	...
	const options: () => Option[] = () => artworksMemo.categories.map(category => ({ value: category, label: category }))

	return (
		<FilterPanel filterType="category" title="Category">
			<Select
